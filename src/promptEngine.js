  ...
  blockOrder.forEach(blockId => {
    switch (blockId) {
      ...
      case 'visual': {
        ...
        parts.push(`# STEP 6 : DIRECT IMAGE GENERATION BY GPT Image (ChatGPT Image)\n\nเมื่อคุณ (AI) วิเคราะห์และแสดงผลลัพธ์โครงสร้างเนื้อหาข้อมูลด้านบนเสร็จสิ้นแล้ว ให้หยุดและถามผู้ใช้ปิดท้ายเพื่อยืนยันว่า:\n"ข้อมูลการวิเคราะห์และสรุปเนื้อหาข้างต้นเสร็จเรียบร้อยแล้ว ต้องการให้ผมวาดและสร้างภาพกราฟิกสรุปข้อมูล (Infographic/Slide Deck) ออกมาให้เลยหรือไม่ครับ? (หากพร้อมแล้ว พิมพ์บอกได้เลยครับ)"\n\nเมื่อผู้ใช้งานกดยืนยันตอบรับว่าต้องการ ให้คุณ (AI) เรียกใช้ความสามารถในการสร้างภาพในตัวของคุณ (GPT Image / ChatGPT Image) เพื่อวาดและเจเนอเรตภาพจริงออกมาแสดงในแชตทันที โดยนำข้อมูลสรุปการวิเคราะห์ด้านบนมาจัดเรียงในรูปภาพตามพารามิเตอร์ดีไซน์นี้:\n\n${specs.join('\n')}\n\n*ข้อเน้นย้ำ: ให้ GPT Image (ChatGPT Image) วาดรูปภาพสำเร็จรูปแสดงข้อมูลเชิงตัวเลขและเนื้อหาภาษาไทยตามสรุปข้างต้น ห้ามเขียนออกมาเป็น Text Prompt และต้องเน้นความชัดเจนของข้อมูลที่สรุปได้ให้อ่านง่ายเป็นสำคัญ (Function First, Form Follows Function)*`);
        break;
      }
    }
  });
